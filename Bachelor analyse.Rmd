...
ggplot(CIData, aes(as.numeric(KnowledgeMusic), Correct, color=Condition))+geom_smooth(method=lm)+labs(x="Knowledge og Music", title="Knowledge of Music and Performance")
