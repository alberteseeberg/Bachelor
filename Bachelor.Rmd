...
m5=glmer(Correct~Condition+AlderOP+(1|ID), data=PitchCI, family=binomial)
summary(m5)


m6=glmer(Correct~Condition+AlderOP+AarUdenHoerelse+(1|ID), data=PitchCI, family=binomial)
summary(m6)


m7=glmer(Correct~Condition*AlderOP+ AarUdenHoerelse+ Musikviden+(1|ID), data=PitchCI, family=binomial, control = glmerControl(optimizer = "nloptwrap", calc.derivs = FALSE))
summary(m7)

m8=glmer(Correct~Condition+Musikviden+(1|ID), data=PitchCI, family=binomial)
summary(M8)

m9=glmer(Correct~Condition*AlderOP+ AarUdenHoerelse+ Musikviden+ DeviantLevel+(1|ID), data=PitchCI, family=binomial, control = glmerControl(optimizer = "nloptwrap", calc.derivs = FALSE))
...
# m11=glmer(Correct~Condition+AlderOP+AarUdenHoerelse+(1|ID), data=RhythmCI, family=binomial)
# summary(m6)
# 
# 
# m12=glmer(Correct~Condition*AlderOP+ AarUdenHoerelse+ Musikviden+(1|ID), data=RhythmCI, family=binomial, control = glmerControl(optimizer = "nloptwrap", calc.derivs = FALSE))
# summary(m7)
# 
# m13=glmer(Correct~Condition+Musikviden+(1|ID), data=RhythmCI, family=binomial)
# summary(M8)
# 
# m14=glmer(Correct~Condition*AlderOP+ AarUdenHoerelse+ Musikviden+ DeviantLevel+(1|ID), data=RhythmCI, family=binomial, control = glmerControl(optimizer = "nloptwrap", calc.derivs = FALSE))

anova(m10,m11,m12,m13,m14)

TimbreCI <- subset(CIData, Deviant=="Timbre")

m15=glmer(Correct~Condition*DeviantLevel+(1|ID), data=TimbreCI, family=binomial)
summary(m15)


# m16=glmer(Correct~Condition+AlderOP+AarUdenHoerelse+(1|ID), data=TimbreCI, family=binomial)
# summary(m6)
# 
# 
# m17=glmer(Correct~Condition*AlderOP+ AarUdenHoerelse+ Musikviden+(1|ID), data=TimbreCI, family=binomial, control = glmerControl(optimizer = "nloptwrap", calc.derivs = FALSE))
# summary(m7)
# 
# m18=glmer(Correct~Condition+Musikviden+(1|ID), data=TimbreCI, family=binomial)
# summary(M8)
# 
# m19=glmer(Correct~Condition*AlderOP+ AarUdenHoerelse+ Musikviden+ DeviantLevel+(1|ID), data=TimbreCI, family=binomial, control = glmerControl(optimizer = "nloptwrap", calc.derivs = FALSE))

anova(m15,m16,m17,m18,m19)


IntensityCI <- subset(CIData, Deviant=="Intensitet")

m20=glmer(Correct~Condition+AlderOP+(1|ID), data=IntensityCI, family=binomial, control = glmerControl(optimizer = "nloptwrap", calc.derivs = FALSE))
summary(m5)


m21=glmer(Correct~Condition+AlderOP+AarUdenHoerelse+(1|ID), data=IntensityCI, family=binomial)
summary(m6)


m22=glmer(Correct~Condition*AlderOP+ AarUdenHoerelse+ Musikviden+(1|ID), data=IntensityCI, family=binomial, control = glmerControl(optimizer = "nloptwrap", calc.derivs = FALSE))
summary(m7)

m23=glmer(Correct~Condition+Musikviden+(1|ID), data=IntensityCI, family=binomial)
summary(M8)

m24=glmer(Correct~Condition*AlderOP+ AarUdenHoerelse+ Musikviden+ DeviantLevel+(1|ID), data=IntensityCI, family=binomial, control = glmerControl(optimizer = "nloptwrap", calc.derivs = FALSE))

anova(m20,m21,m22,m23,m24)
...
m30=glmer(Correct~Deviant+(1|ID), data=CIData, family=binomial)
summary(m30)
